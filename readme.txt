...
== Changelog ==
== 1.1.0 ==
* Update IcoFont license list
* Update footer template for translateable text
* Update logo visibility in customizer
* Use wp_body_open function in header-empty template
* Delete *.map files
...
* Fix escaping in footer section
* Remove unused customizer settings
* Update language pot file
* Fix go top button color

= 1.0.2 =
* Refactor textdomain names from msbdbp to business-profile.
* Add prefixes for bariables
* Fix translations for few text
